  ...
  render() {
    return (
        ...
        <div className="m-login-content">
            ...
            <input type="number" pattern="\d*" placeholder="用户名可为数字、字母、下划线" className="u-input phone-number" />
            <i className="clear-icon" style="display: block;"></i>
            <input type="number" pattern="\d*" placeholder="6-16位密码，区分大小写" className="u-input phone-number" />
            <a href="javascript:;" id="getCode" className="u-button disable">注册</a>
            <a href="javascript:;" id="logCode" className="u-button disable">登录</a>
	        </div>
        </div>
